...
@section('content')
      ...
      <div class="table-responsive">
        <table class="app-sales-table">
          ...
          <tbody>
            ...
            <tr>
              <td>{{ $jenisKendaraans->firstItem() + $i }}</td>
              <td>
                <div class="app-info">
                  <div>
        ...
        @include('partials.pagination', ['paginator' => $jenisKendaraans])
      </div>
    </div>
  ...
  <div class="modal-overlay" id="jenisKendaraanModal">
    <div class="modal">
      ...
      <form id="jenisKendaraanForm" class="ajax-form" method="POST"
  ...
  <div class="modal-overlay" id="deleteJenisKendaraanModal">
    <div class="modal modal-confirm">
      ...
      <form id="deleteJenisKendaraanForm" class="ajax-form" method="POST" action="">
        @csrf
        @method('DELETE')
